 ...
 int width, int height, int depth, boolean fullscreen, boolean resize)
{
  ...
  regGP1 = 0x0800002F; // Video mode: 640x480i 15bpp NTSC
  regGP1 = (0x05<<24)
...
static boolean psxgpu_init_video(struct graphics_data *graphics,
...
void render_psx_register(struct renderer *renderer)
{
  ...
  renderer->remap_char_range = psxgpu_remap_char_range;
